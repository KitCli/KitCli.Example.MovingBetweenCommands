...
The blank line after each link is issue [#290](https://github.com/KitCli/KitCli/issues/290): `.ByMovingToCommand<T>()` prints an extra newline that `.BySaying(...)` on its own does not.
